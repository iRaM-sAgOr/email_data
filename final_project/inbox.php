    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
      ...
      <script>
          $('form.ajax').on('submit', function() {
              ...
              that.find('[name]').each(function(inbox, value) {
                  var that = $(this),
                      name = that.attr('name'),
                      value = that.val();
      ...
      <div class="modal fade" id="contact" role="dialog">
          <div class="modal-dialog">
              <div class="modal-content">
                  <form id="contact-form" class="form-horizontal ajax" role="form" action="inbox.php" method="post">
                      ...
                      <div class="modal-body" id="modal-body-id">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="" name="" class="form-control" id="contact-email" placeholder="Subject">
                              </div>
                          </div>
                          <div class="form-group">
