			...
			if(isset($_POST['login']))
			{
				...
				if($query_run1 )
				{
					if(mysqli_num_rows($query_run1)>0)
					{
						...
						header("location:inbox.php",  true,  301 );  exit;
					}
		            else
					{
...
<body >
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('login_page/images/bg-01.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form action="index.php" method="post" enctype="multipart/form-data" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						...
						<a href="login_page/signup.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Sign Up
